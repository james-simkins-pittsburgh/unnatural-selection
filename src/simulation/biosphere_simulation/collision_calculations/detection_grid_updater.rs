...
pub fn update_for_movement(
    ...
    all_spatial_biosphere_information.collision_detection_grid[
    ...
    all_spatial_biosphere_information.collision_detection_grid[
        ((all_spatial_biosphere_information.organism_information_vec[organism_number].x_location +
            game_settings.map_length / 2) /
            GRID_SIZE) as usize
    ][
        ((all_spatial_biosphere_information.organism_information_vec[organism_number].y_location +
